...
`
    ...
    function create_fragment$1(ctx) {
    	...
    	let footer;
    	let small;
    	let t17_value = /*appData*/ ctx[1].title + "";
    	let t17;
    	let t18;
    	let t19_value = /*appData*/ ctx[1].version + "";
    	let t19;
    	let t20;
    	let a;
    	let t21;
    	let a_href_value;
    	let t22;
    	let t23_value = /*appData*/ ctx[1].copyright + "";
    	let t23;
    	let t24;
    	let t25_value = /*appData*/ ctx[1].version + "";
    	let t25;
    	let t26;
    	let current;
    	let mounted;
    	...
    	options_1.$on("saveOptions", /*saveOptions*/ ctx[7]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t20 = text(". See the ");
    			a = element("a");
    			t21 = text("github repo");
    			t22 = text(" for details. ");
    			t23 = text(t23_value);
    			t24 = text(" Last updated ");
    			t25 = text(t25_value);
    			t26 = text(".");
    			add_location(h2, file$1, 73, 1, 2031);
    			add_location(i, file$1, 75, 15, 2073);
    			add_location(strong, file$1, 75, 7, 2065);
    			add_location(p, file$1, 75, 1, 2059);
    			add_location(button0, file$1, 78, 2, 2182);
    			add_location(button1, file$1, 79, 2, 2271);
    			attr_dev(div0, "class", "bottomSpaced");
    			add_location(div0, file$1, 77, 1, 2153);
    			add_location(button2, file$1, 82, 2, 2338);
    			add_location(div1, file$1, 81, 1, 2330);
    			add_location(h3, file$1, 87, 1, 2493);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 88, 1, 2511);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file$1, 91, 52, 2607);
    			add_location(small, file$1, 91, 2, 2557);
    			add_location(footer, file$1, 90, 1, 2546);
    			add_location(main, file$1, 72, 0, 2023);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*saveOptions*/ ctx[7], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*output*/ 8) set_data_dev(t15, /*output*/ ctx[3]);
    			if ((!current || dirty & /*appData*/ 2) && t17_value !== (t17_value = /*appData*/ ctx[1].title + "")) set_data_dev(t17, t17_value);
    			if ((!current || dirty & /*appData*/ 2) && t19_value !== (t19_value = /*appData*/ ctx[1].version + "")) set_data_dev(t19, t19_value);

    			if (!current || dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 2) && t23_value !== (t23_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t23, t23_value);
    			if ((!current || dirty & /*appData*/ 2) && t25_value !== (t25_value = /*appData*/ ctx[1].version + "")) set_data_dev(t25, t25_value);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		...
    		$$invalidate(8, results.starSystem = starSystems.createStarSystem(starData, options), results);
    	...
    	function handleNewCargoJob() {
    		$$invalidate(8, results = {});
    		$$invalidate(8, results.job = jobs.createCargoRunJob(jobsData, options), results);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("jobsData" in $$props) $$invalidate(9, jobsData = $$props.jobsData);
    		if ("options" in $$props) $$invalidate(0, options = $$props.options);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*jobsData*/ ctx[9] === undefined && !("jobsData" in props)) {
    		...
    		if (/*results*/ ctx[8] === undefined && !("results" in props)) {
    ...
    var version = "10 Sep 2020 15:52:24";
