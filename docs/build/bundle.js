...
`
    ...
    function create_fragment$1(ctx) {
    	...
    	let footer;
    	let small;
    	let t15_value = /*appData*/ ctx[1].title + "";
    	let t15;
    	let t16;
    	let t17_value = /*appData*/ ctx[1].version + "";
    	let t17;
    	let t18;
    	let a;
    	let t19;
    	let a_href_value;
    	let t20;
    	let t21_value = /*appData*/ ctx[1].copyright + "";
    	let t21;
    	let t22;
    	let t23_value = /*appData*/ ctx[1].version + "";
    	let t23;
    	let t24;
    	let current;
    	let mounted;
    	...
    	options_1.$on("saveOptions", /*saveOptions*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = text(". See the ");
    			a = element("a");
    			t19 = text("github repo");
    			t20 = text(" for details. ");
    			t21 = text(t21_value);
    			t22 = text(" Last updated ");
    			t23 = text(t23_value);
    			t24 = text(".");
    			add_location(h2, file$1, 50, 1, 1584);
    			add_location(i, file$1, 52, 15, 1626);
    			add_location(strong, file$1, 52, 7, 1618);
    			add_location(p, file$1, 52, 1, 1612);
    			add_location(button0, file$1, 54, 1, 1706);
    			add_location(button1, file$1, 55, 1, 1794);
    			add_location(h3, file$1, 59, 1, 1931);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 60, 1, 1949);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file$1, 63, 52, 2045);
    			add_location(small, file$1, 63, 2, 1995);
    			add_location(footer, file$1, 62, 1, 1984);
    			add_location(main, file$1, 49, 0, 1576);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*saveOptions*/ ctx[6], false, false, false),
    					listen_dev(button0, "click", /*handleNewStarSystem*/ ctx[4], false, false, false),
    					listen_dev(button1, "click", /*handleOptions*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*output*/ 8) set_data_dev(t13, /*output*/ ctx[3]);
    			if ((!current || dirty & /*appData*/ 2) && t15_value !== (t15_value = /*appData*/ ctx[1].title + "")) set_data_dev(t15, t15_value);
    			if ((!current || dirty & /*appData*/ 2) && t17_value !== (t17_value = /*appData*/ ctx[1].version + "")) set_data_dev(t17, t17_value);

    			if (!current || dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 2) && t21_value !== (t21_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t21, t21_value);
    			if ((!current || dirty & /*appData*/ 2) && t23_value !== (t23_value = /*appData*/ ctx[1].version + "")) set_data_dev(t23, t23_value);
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*starData*/ ctx[2] === undefined && !("starData" in props)) {
    			console_1.warn("<App> was created without expected prop 'starData'");
    		}
    		...
    		if (/*results*/ ctx[7] === undefined && !("results" in props)) {
    			console_1.warn("<App> was created without expected prop 'results'");
    		}
    	}
    ...
    var version = "10 Sep 2020 15:31:29";
