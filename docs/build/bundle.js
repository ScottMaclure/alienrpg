...
`
    ...
    function create_fragment(ctx) {
    	...
    	let footer;
    	let small1;
    	let t14_value = /*appData*/ ctx[0].title + "";
    	let t14;
    	let t15;
    	let t16_value = /*appData*/ ctx[0].version + "";
    	let t16;
    	let t17;
    	let a;
    	let t18;
    	let a_href_value;
    	let t19;
    	let t20_value = /*appData*/ ctx[0].copyright + "";
    	let t20;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t17 = text(". See the ");
    			a = element("a");
    			t18 = text("github repo");
    			t19 = text(" for details. ");
    			t20 = text(t20_value);
    			add_location(small0, file, 21, 25, 484);
    			attr_dev(div, "class", "alignRight");
    			add_location(div, file, 21, 1, 460);
    			add_location(h2, file, 22, 1, 524);
    			add_location(i, file, 23, 15, 564);
    			add_location(strong, file, 23, 7, 556);
    			add_location(p, file, 23, 1, 550);
    			add_location(button, file, 24, 1, 642);
    			add_location(h3, file, 26, 1, 712);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file, 27, 1, 730);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[0].githubUrl);
    			add_location(a, file, 30, 52, 826);
    			add_location(small1, file, 30, 2, 776);
    			add_location(footer, file, 29, 1, 765);
    			add_location(main, file, 20, 0, 452);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleNewStarSystem*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*output*/ 2) set_data_dev(t12, /*output*/ ctx[1]);
    			if (dirty & /*appData*/ 1 && t14_value !== (t14_value = /*appData*/ ctx[0].title + "")) set_data_dev(t14, t14_value);
    			if (dirty & /*appData*/ 1 && t16_value !== (t16_value = /*appData*/ ctx[0].version + "")) set_data_dev(t16, t16_value);

    			if (dirty & /*appData*/ 1 && a_href_value !== (a_href_value = /*appData*/ ctx[0].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if (dirty & /*appData*/ 1 && t20_value !== (t20_value = /*appData*/ ctx[0].copyright + "")) set_data_dev(t20, t20_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		...
    		$$invalidate(1, output = starSystemPrinter.printStarSystem(results));
    	}
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("starData" in $$props) $$invalidate(3, starData = $$props.starData);
    	};
    	...
    	return [appData, output, handleNewStarSystem, starData];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { appData: 0, starData: 3 });
    		...
    		if (/*starData*/ ctx[3] === undefined && !("starData" in props)) {
