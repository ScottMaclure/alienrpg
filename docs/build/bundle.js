...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 40, 24, 1551);
    			add_location(label, file, 38, 20, 1386);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend, file, 26, 12, 883);
    			attr_dev(div0, "class", "subTitle svelte-1hhmr6j");
    			add_location(div0, file, 28, 12, 947);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 31, 20, 1055);
    			add_location(label, file, 30, 16, 1026);
    			add_location(div1, file, 29, 12, 1003);
    			attr_dev(div2, "class", "subTitle svelte-1hhmr6j");
    			add_location(div2, file, 35, 12, 1250);
    			add_location(div3, file, 36, 12, 1312);
    			add_location(fieldset, file, 25, 8, 859);
    			add_location(form, file, 24, 4, 843);

    			set_style(div4, "display", /*options*/ ctx[0].showOptions === false
    			? "none"
    			: "block");

    			add_location(div4, file, 23, 0, 764);
    		},
    ...
    class Options extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { starData: 4, options: 0 });
...
Ship Reaction:         ${results.reaction.type}`
    ...
    function create_fragment$1(ctx) {
    	...
    	let a_href_value;
    	let t47;
    	let t48_value = /*appData*/ ctx[1].copyright + "";
    	let t48;
    	let t49;
    	let t50_value = /*appData*/ ctx[1].version + "";
    	let t50;
    	let t51;
    	let current;
    	let mounted;
    	...
    	options_1 = new Options({
    			props: {
    				starData: /*starData*/ ctx[2],
    				options: /*options*/ ctx[0]
    			},
    			$$inline: true
    		});

    	options_1.$on("saveOptions", /*saveOptions*/ ctx[12]);
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			h41 = element("h4");
    			h41.textContent = "Jobs";
    			t14 = space();
    			button2 = element("button");
    			button2.textContent = "Cargo Run";
    			t16 = space();
    			button3 = element("button");
    			button3.textContent = "Military Mission";
    			t18 = space();
    			button4 = element("button");
    			button4.textContent = "Expedition";
    			t20 = space();
    			div2 = element("div");
    			h42 = element("h4");
    			h42.textContent = "Star System Encounters";
    			t22 = space();
    			button5 = element("button");
    			button5.textContent = "System";
    			t24 = space();
    			button6 = element("button");
    			button6.textContent = "Rim/Frontier";
    			t26 = space();
    			button7 = element("button");
    			button7.textContent = "Uncharted";
    			t28 = space();
    			h43 = element("h4");
    			h43.textContent = "Surface Encounters";
    			t30 = space();
    			button8 = element("button");
    			button8.textContent = "Uninhabited World";
    			t32 = space();
    			button9 = element("button");
    			button9.textContent = "Colonized World";
    			t34 = space();
    			h44 = element("h4");
    			h44.textContent = "Colony Encounters";
    			t36 = space();
    			button10 = element("button");
    			button10.textContent = "Young Colony";
    			t38 = space();
    			button11 = element("button");
    			button11.textContent = "Established Colony";
    			t40 = space();
    			h45 = element("h4");
    			h45.textContent = "Results";
    			t42 = space();
    			pre = element("pre");
    			t43 = text(/*output*/ ctx[3]);
    			t44 = space();
    			footer = element("footer");
    			small = element("small");
    			t45 = text("See the ");
    			a = element("a");
    			t46 = text("github repo");
    			t47 = text(" for details. ");
    			t48 = text(t48_value);
    			t49 = text(" Last updated ");
    			t50 = text(t50_value);
    			t51 = text(".");
    			add_location(h2, file$1, 115, 1, 3563);
    			add_location(i, file$1, 117, 15, 3605);
    			add_location(strong, file$1, 117, 7, 3597);
    			add_location(p, file$1, 117, 1, 3591);
    			add_location(h40, file$1, 120, 2, 3714);
    			add_location(button0, file$1, 121, 2, 3733);
    			add_location(button1, file$1, 122, 2, 3818);
    			attr_dev(div0, "class", "bottomSpaced");
    			add_location(div0, file$1, 119, 1, 3685);
    			add_location(h41, file$1, 126, 2, 3986);
    			add_location(button2, file$1, 127, 2, 4002);
    			add_location(button3, file$1, 128, 2, 4060);
    			add_location(button4, file$1, 129, 2, 4132);
    			attr_dev(div1, "class", "bottomSpaced");
    			add_location(div1, file$1, 125, 1, 3957);
    			add_location(h42, file$1, 132, 2, 4229);
    			add_location(button5, file$1, 133, 2, 4263);
    			add_location(button6, file$1, 134, 2, 4333);
    			add_location(button7, file$1, 135, 2, 4411);
    			add_location(h43, file$1, 136, 2, 4486);
    			add_location(button8, file$1, 137, 2, 4516);
    			add_location(button9, file$1, 138, 2, 4607);
    			add_location(h44, file$1, 139, 2, 4694);
    			add_location(button10, file$1, 140, 2, 4723);
    			add_location(button11, file$1, 141, 2, 4796);
    			attr_dev(div2, "class", "bottomSpaced");
    			add_location(div2, file$1, 131, 1, 4200);
    			add_location(h45, file$1, 144, 1, 4885);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 145, 1, 4903);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file$1, 148, 17, 4964);
    			add_location(small, file$1, 148, 2, 4949);
    			add_location(footer, file$1, 147, 1, 4938);
    			add_location(main, file$1, 114, 0, 3555);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(small, t45);
    			append_dev(small, a);
    			append_dev(a, t46);
    			append_dev(small, t47);
    			append_dev(small, t48);
    			append_dev(small, t49);
    			append_dev(small, t50);
    			append_dev(small, t51);
    			current = true;

    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*saveOptions*/ ctx[12], false, false, false),
    					listen_dev(button0, "click", /*handleNewStarSystem*/ ctx[5], false, false, false),
    					listen_dev(button1, "click", /*handleOptions*/ ctx[4], false, false, false),
    					listen_dev(button2, "click", /*handleNewCargoJob*/ ctx[6], false, false, false),
    					listen_dev(button3, "click", /*handleNewMilitaryMission*/ ctx[7], false, false, false),
    					listen_dev(button4, "click", /*handleNewExpedition*/ ctx[8], false, false, false),
    					listen_dev(button5, "click", /*click_handler*/ ctx[16], false, false, false),
    					listen_dev(button6, "click", /*click_handler_1*/ ctx[17], false, false, false),
    					listen_dev(button7, "click", /*click_handler_2*/ ctx[18], false, false, false),
    					listen_dev(button8, "click", /*click_handler_3*/ ctx[19], false, false, false),
    					listen_dev(button9, "click", /*click_handler_4*/ ctx[20], false, false, false),
    					listen_dev(button10, "click", /*click_handler_5*/ ctx[21], false, false, false),
    					listen_dev(button11, "click", /*click_handler_6*/ ctx[22], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*appData*/ 2) && t0_value !== (t0_value = /*appData*/ ctx[1].title + "")) set_data_dev(t0, t0_value);
    			const options_1_changes = {};
    			if (dirty & /*starData*/ 4) options_1_changes.starData = /*starData*/ ctx[2];
    			if (dirty & /*options*/ 1) options_1_changes.options = /*options*/ ctx[0];
    			options_1.$set(options_1_changes);
    			if (!current || dirty & /*output*/ 8) set_data_dev(t43, /*output*/ ctx[3]);

    			if (!current || dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 2) && t48_value !== (t48_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t48, t48_value);
    			if ((!current || dirty & /*appData*/ 2) && t50_value !== (t50_value = /*appData*/ ctx[1].version + "")) set_data_dev(t50, t50_value);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.starSystem = starSystems.createStarSystem(starData, options), results);
    		$$invalidate(3, output = starSystemPrinter.printStarSystem(results.starSystem, options));
    		saveData();
    	}

    	function handleNewCargoJob() {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.job = jobs.createCargoRunJob(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}

    	function handleNewMilitaryMission() {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.job = jobs.createMilitaryMission(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}
    	...
    	function handleNewExpedition() {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.job = jobs.createExpedition(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}
    	...
    	function handleStarSystemEncounter(tensMod = 0) {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.starSystemEncounter = encounters.createStarSystemEncounter(encountersData, tensMod), results);
    		$$invalidate(3, output = encountersPrinter.printStarSystemEncounter(results.starSystemEncounter, options));
    		saveData();
    	}

    	function handleSurfaceEncounter(type) {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.surfaceEncounter = encounters.createSurfaceEncounter(encountersData, type), results);
    		$$invalidate(3, output = encountersPrinter.printSurfaceEncounter(results.surfaceEncounter, options));
    		saveData();
    	}

    	function handleColonyEncounter(tensMod) {
    		$$invalidate(13, results = {});
    		$$invalidate(13, results.colonyEncounter = encounters.createColonyEncounter(encountersData, tensMod), results);
    		$$invalidate(3, output = encountersPrinter.printColonyEncounter(results.colonyEncounter, options));
    		saveData();
    	}
    	...
    	const writable_props = ["appData", "starData", "jobsData", "encountersData", "options", "results"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("starData" in $$props) $$invalidate(2, starData = $$props.starData);
    		if ("jobsData" in $$props) $$invalidate(14, jobsData = $$props.jobsData);
    		if ("encountersData" in $$props) $$invalidate(15, encountersData = $$props.encountersData);
    		if ("options" in $$props) $$invalidate(0, options = $$props.options);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*starData*/ ctx[2] === undefined && !("starData" in props)) {
    			console.warn("<App> was created without expected prop 'starData'");
    		}

    		if (/*jobsData*/ ctx[14] === undefined && !("jobsData" in props)) {
    			console.warn("<App> was created without expected prop 'jobsData'");
    		}

    		if (/*encountersData*/ ctx[15] === undefined && !("encountersData" in props)) {
    			console.warn("<App> was created without expected prop 'encountersData'");
    		}
    		...
    		if (/*results*/ ctx[13] === undefined && !("results" in props)) {
    ...
    var version = "11 Sep 2020 09:37:28";
