...
`
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 65, 6, 2087);
    			add_location(label, file, 63, 5, 1960);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label = element("label");
    			input = element("input");
    			t10 = text(" Show uninhabited details");
    			t11 = space();
    			...
    			t27 = text(t27_value);
    			t28 = text(".");
    			add_location(h2, file, 45, 1, 1409);
    			add_location(i, file, 47, 15, 1451);
    			add_location(strong, file, 47, 7, 1443);
    			add_location(p, file, 47, 1, 1437);
    			add_location(button, file, 49, 1, 1531);
    			add_location(legend0, file, 52, 3, 1642);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 55, 5, 1693);
    			add_location(label, file, 54, 4, 1680);
    			add_location(div0, file, 53, 3, 1670);
    			add_location(fieldset0, file, 51, 2, 1628);
    			add_location(legend1, file, 60, 3, 1874);
    			add_location(div1, file, 61, 3, 1915);
    			add_location(fieldset1, file, 59, 2, 1860);
    			add_location(form, file, 50, 1, 1619);
    			add_location(h3, file, 72, 1, 2258);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file, 73, 1, 2276);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file, 76, 52, 2372);
    			add_location(small, file, 76, 2, 2322);
    			add_location(footer, file, 75, 1, 2311);
    ...
    var version = "10 Sep 2020 10:14:36";
