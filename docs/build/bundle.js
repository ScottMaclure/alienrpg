...
var app = (function () {
    ...
    // (37:16) {#each starLocations as item}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 39, 24, 1417);
    			add_location(label, file, 37, 20, 1252);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:16) {#each starLocations as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend0, file, 26, 12, 815);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 29, 20, 905);
    			add_location(label, file, 28, 16, 876);
    			add_location(div0, file, 27, 12, 853);
    			add_location(fieldset0, file, 25, 8, 791);
    			add_location(legend1, file, 34, 12, 1127);
    			add_location(div1, file, 35, 12, 1178);
    			add_location(fieldset1, file, 33, 8, 1103);
    			add_location(form, file, 24, 4, 775);
    			add_location(div2, file, 23, 0, 764);
    		},
...
`
    ...
    function create_fragment$1(ctx) {
    	...
    	let footer;
    	let small;
    	let t13_value = /*appData*/ ctx[0].title + "";
    	let t13;
    	let t14;
    	let t15_value = /*appData*/ ctx[0].version + "";
    	let t15;
    	let t16;
    	let a;
    	let t17;
    	let a_href_value;
    	let t18;
    	let t19_value = /*appData*/ ctx[0].copyright + "";
    	let t19;
    	let t20;
    	let t21_value = /*appData*/ ctx[0].version + "";
    	let t21;
    	let t22;
    	let current;
    	let mounted;
    	...
    	options_1 = new Options({
    			props: {
    				starData: /*starData*/ ctx[1],
    				options: /*options*/ ctx[2]
    			},
    			$$inline: true
    		});

    	options_1.$on("saveOptions", /*saveOptions*/ ctx[5]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t16 = text(". See the ");
    			a = element("a");
    			t17 = text("github repo");
    			t18 = text(" for details. ");
    			t19 = text(t19_value);
    			t20 = text(" Last updated ");
    			t21 = text(t21_value);
    			t22 = text(".");
    			add_location(h2, file$1, 44, 1, 1442);
    			add_location(i, file$1, 46, 15, 1484);
    			add_location(strong, file$1, 46, 7, 1476);
    			add_location(p, file$1, 46, 1, 1470);
    			add_location(button, file$1, 48, 1, 1564);
    			add_location(h3, file$1, 52, 1, 1738);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 53, 1, 1756);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[0].githubUrl);
    			add_location(a, file$1, 56, 52, 1852);
    			add_location(small, file$1, 56, 2, 1802);
    			add_location(footer, file$1, 55, 1, 1791);
    			add_location(main, file$1, 43, 0, 1434);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button, "click", /*saveOptions*/ ctx[5], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*appData*/ 1) && t0_value !== (t0_value = /*appData*/ ctx[0].title + "")) set_data_dev(t0, t0_value);
    			const options_1_changes = {};
    			if (dirty & /*starData*/ 2) options_1_changes.starData = /*starData*/ ctx[1];
    			if (dirty & /*options*/ 4) options_1_changes.options = /*options*/ ctx[2];
    			options_1.$set(options_1_changes);
    			if (!current || dirty & /*output*/ 8) set_data_dev(t11, /*output*/ ctx[3]);
    			if ((!current || dirty & /*appData*/ 1) && t13_value !== (t13_value = /*appData*/ ctx[0].title + "")) set_data_dev(t13, t13_value);
    			if ((!current || dirty & /*appData*/ 1) && t15_value !== (t15_value = /*appData*/ ctx[0].version + "")) set_data_dev(t15, t15_value);

    			if (!current || dirty & /*appData*/ 1 && a_href_value !== (a_href_value = /*appData*/ ctx[0].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 1) && t19_value !== (t19_value = /*appData*/ ctx[0].copyright + "")) set_data_dev(t19, t19_value);
    			if ((!current || dirty & /*appData*/ 1) && t21_value !== (t21_value = /*appData*/ ctx[0].version + "")) set_data_dev(t21, t21_value);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		$$invalidate(6, results = starSystems.createStarSystem(starData, options));
    		$$invalidate(3, output = starSystemPrinter.printStarSystem(results, options));
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("starData" in $$props) $$invalidate(1, starData = $$props.starData);
    	...
    	return [appData, starData, options, output, handleNewStarSystem, saveOptions, results];
    }
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*starData*/ ctx[1] === undefined && !("starData" in props)) {
    ...
    var version = "10 Sep 2020 14:48:53";
