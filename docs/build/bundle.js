...
`
    ...
    function create_fragment$1(ctx) {
    	...
    	let a_href_value;
    	let t21;
    	let t22_value = /*appData*/ ctx[1].copyright + "";
    	let t22;
    	let t23;
    	let t24_value = /*appData*/ ctx[1].version + "";
    	let t24;
    	let t25;
    	let current;
    	let mounted;
    	...
    	options_1.$on("saveOptions", /*saveOptions*/ ctx[8]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t16 = space();
    			pre = element("pre");
    			t17 = text(/*output*/ ctx[3]);
    			t18 = space();
    			footer = element("footer");
    			small = element("small");
    			t19 = text("See the ");
    			a = element("a");
    			t20 = text("github repo");
    			t21 = text(" for details. ");
    			t22 = text(t22_value);
    			t23 = text(" Last updated ");
    			t24 = text(t24_value);
    			t25 = text(".");
    			add_location(h2, file$1, 80, 1, 2219);
    			add_location(i, file$1, 82, 15, 2261);
    			add_location(strong, file$1, 82, 7, 2253);
    			add_location(p, file$1, 82, 1, 2247);
    			add_location(button0, file$1, 85, 2, 2370);
    			add_location(button1, file$1, 86, 2, 2459);
    			attr_dev(div0, "class", "bottomSpaced");
    			add_location(div0, file$1, 84, 1, 2341);
    			add_location(button2, file$1, 89, 2, 2526);
    			add_location(button3, file$1, 90, 2, 2588);
    			add_location(div1, file$1, 88, 1, 2518);
    			add_location(h3, file$1, 95, 1, 2748);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 96, 1, 2766);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file$1, 99, 17, 2827);
    			add_location(small, file$1, 99, 2, 2812);
    			add_location(footer, file$1, 98, 1, 2801);
    			add_location(main, file$1, 79, 0, 2211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*saveOptions*/ ctx[8], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*output*/ 8) set_data_dev(t17, /*output*/ ctx[3]);

    			if (!current || dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 2) && t22_value !== (t22_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t22, t22_value);
    			if ((!current || dirty & /*appData*/ 2) && t24_value !== (t24_value = /*appData*/ ctx[1].version + "")) set_data_dev(t24, t24_value);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		...
    		$$invalidate(9, results.starSystem = starSystems.createStarSystem(starData, options), results);
    	...
    	function handleNewCargoJob() {
    		$$invalidate(9, results = {});
    		$$invalidate(9, results.job = jobs.createCargoRunJob(jobsData, options), results);
    	...
    	function handleNewMilitaryMission() {
    		$$invalidate(9, results = {});
    		$$invalidate(9, results.job = jobs.createMilitaryMission(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("jobsData" in $$props) $$invalidate(10, jobsData = $$props.jobsData);
    		if ("options" in $$props) $$invalidate(0, options = $$props.options);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*jobsData*/ ctx[10] === undefined && !("jobsData" in props)) {
    		...
    		if (/*results*/ ctx[9] === undefined && !("results" in props)) {
    ...
    var version = "10 Sep 2020 17:21:50";
