    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 66, 6, 2151);
    			add_location(label, file, 64, 5, 2024);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div2, file, 62, 3, 1979);
    			add_location(fieldset1, file, 60, 2, 1924);
    			add_location(form, file, 51, 1, 1683);
    			add_location(h3, file, 73, 1, 2322);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file, 74, 1, 2340);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file, 77, 52, 2436);
    			add_location(small1, file, 77, 2, 2386);
    			add_location(footer, file, 76, 1, 2375);
