...
`
    ...
    function create_fragment$1(ctx) {
    	...
    	let t24;
    	let t25;
    	let t26_value = /*appData*/ ctx[1].version + "";
    	let t26;
    	let t27;
    	let current;
    	let mounted;
    	...
    	options_1.$on("saveOptions", /*saveOptions*/ ctx[9]);
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "New Star System";
    			t7 = space();
    			...
    			button2.textContent = "New Cargo Run";
    			t11 = space();
    			button3 = element("button");
    			button3.textContent = "New Mission";
    			t13 = space();
    			button4 = element("button");
    			button4.textContent = "New Expedition";
    			t15 = space();
    			...
    			t24 = text(t24_value);
    			t25 = text(" Last updated ");
    			t26 = text(t26_value);
    			t27 = text(".");
    			add_location(h2, file$1, 87, 1, 2397);
    			add_location(i, file$1, 89, 15, 2439);
    			add_location(strong, file$1, 89, 7, 2431);
    			add_location(p, file$1, 89, 1, 2425);
    			add_location(button0, file$1, 92, 2, 2548);
    			add_location(button1, file$1, 93, 2, 2637);
    			attr_dev(div0, "class", "bottomSpaced");
    			add_location(div0, file$1, 91, 1, 2519);
    			add_location(button2, file$1, 96, 2, 2704);
    			add_location(button3, file$1, 97, 2, 2766);
    			add_location(button4, file$1, 98, 2, 2833);
    			add_location(div1, file$1, 95, 1, 2696);
    			add_location(h3, file$1, 103, 1, 2991);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$1, 104, 1, 3009);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file$1, 107, 17, 3070);
    			add_location(small, file$1, 107, 2, 3055);
    			add_location(footer, file$1, 106, 1, 3044);
    			add_location(main, file$1, 86, 0, 2389);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t15);
    			mount_component(options_1, main, null);
    			append_dev(main, t16);
    			append_dev(main, h3);
    			append_dev(main, t18);
    			append_dev(main, pre);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*saveOptions*/ ctx[9], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*output*/ 8) set_data_dev(t19, /*output*/ ctx[3]);

    			if (!current || dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if ((!current || dirty & /*appData*/ 2) && t24_value !== (t24_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t24, t24_value);
    			if ((!current || dirty & /*appData*/ 2) && t26_value !== (t26_value = /*appData*/ ctx[1].version + "")) set_data_dev(t26, t26_value);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewStarSystem() {
    		$$invalidate(10, results = {});
    		$$invalidate(10, results.starSystem = starSystems.createStarSystem(starData, options), results);
    	...
    	function handleNewCargoJob() {
    		$$invalidate(10, results = {});
    		$$invalidate(10, results.job = jobs.createCargoRunJob(jobsData, options), results);
    	...
    	function handleNewMilitaryMission() {
    		$$invalidate(10, results = {});
    		$$invalidate(10, results.job = jobs.createMilitaryMission(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}
    	...
    	function handleNewExpedition() {
    		$$invalidate(10, results = {});
    		$$invalidate(10, results.job = jobs.createExpedition(jobsData, options), results);
    		$$invalidate(3, output = jobsPrinter.printJob(results.job, options));
    		saveData();
    	}
    	...
    	const writable_props = ["appData", "starData", "jobsData", "options", "results"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("jobsData" in $$props) $$invalidate(11, jobsData = $$props.jobsData);
    		if ("options" in $$props) $$invalidate(0, options = $$props.options);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*jobsData*/ ctx[11] === undefined && !("jobsData" in props)) {
    		...
    		if (/*results*/ ctx[10] === undefined && !("results" in props)) {
    ...
    var version = "11 Sep 2020 09:12:39";
