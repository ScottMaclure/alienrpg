...
`
    ...
    // (64:4) {#each starLocations as item}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 66, 6, 2162);
    			add_location(label, file, 64, 5, 2035);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:4) {#each starLocations as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let footer;
    	let small1;
    	let t21_value = /*appData*/ ctx[1].title + "";
    	let t21;
    	let t22;
    	...
    	let a_href_value;
    	let t26;
    	let t27_value = /*appData*/ ctx[1].copyright + "";
    	let t27;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			legend1.textContent = "Star System Location (Pick One)";
    			t15 = space();
    			div2 = element("div");
    			...
    			t24 = text(". See the ");
    			a = element("a");
    			t25 = text("github repo");
    			t26 = text(" for details. ");
    			t27 = text(t27_value);
    			add_location(small0, file, 45, 25, 1433);
    			attr_dev(div0, "class", "alignRight");
    			add_location(div0, file, 45, 1, 1409);
    			add_location(h2, file, 46, 1, 1473);
    			add_location(i, file, 48, 15, 1515);
    			add_location(strong, file, 48, 7, 1507);
    			add_location(p, file, 48, 1, 1501);
    			add_location(button, file, 50, 1, 1595);
    			add_location(legend0, file, 53, 3, 1706);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 56, 5, 1757);
    			add_location(label, file, 55, 4, 1744);
    			add_location(div1, file, 54, 3, 1734);
    			add_location(fieldset0, file, 52, 2, 1692);
    			add_location(legend1, file, 61, 3, 1938);
    			add_location(div2, file, 62, 3, 1990);
    			add_location(fieldset1, file, 60, 2, 1924);
    			add_location(form, file, 51, 1, 1683);
    			add_location(h3, file, 73, 1, 2333);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file, 74, 1, 2351);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[1].githubUrl);
    			add_location(a, file, 77, 52, 2447);
    			add_location(small1, file, 77, 2, 2397);
    			add_location(footer, file, 76, 1, 2386);
    			add_location(main, file, 44, 0, 1401);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*output*/ 4) set_data_dev(t19, /*output*/ ctx[2]);
    			if (dirty & /*appData*/ 2 && t21_value !== (t21_value = /*appData*/ ctx[1].title + "")) set_data_dev(t21, t21_value);
    			if (dirty & /*appData*/ 2 && t23_value !== (t23_value = /*appData*/ ctx[1].version + "")) set_data_dev(t23, t23_value);

    			if (dirty & /*appData*/ 2 && a_href_value !== (a_href_value = /*appData*/ ctx[1].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if (dirty & /*appData*/ 2 && t27_value !== (t27_value = /*appData*/ ctx[1].copyright + "")) set_data_dev(t27, t27_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
