...
var app = (function () {
    ...
    var version = "11 Sep 2020 11:22:01";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file, 1, 4, 11);
    			add_location(i, file, 2, 18, 52);
    			add_location(strong, file, 2, 10, 44);
    			add_location(p, file, 2, 4, 38);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$2, 57, 1, 1515);
    			add_location(button0, file$2, 58, 1, 1539);
    			add_location(button1, file$2, 59, 1, 1624);
    			add_location(h41, file$2, 63, 1, 1764);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$2, 64, 1, 1783);
    			add_location(div, file$2, 55, 0, 1504);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$3, 54, 1, 1430);
    			add_location(button0, file$3, 55, 1, 1446);
    			add_location(button1, file$3, 56, 1, 1515);
    			add_location(button2, file$3, 57, 1, 1594);
    			add_location(h41, file$3, 59, 1, 1673);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$3, 60, 1, 1692);
    			add_location(div, file$3, 53, 0, 1422);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
Ship Reaction:         ${results.reaction.type}`
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$4, 59, 4, 1965);
    			add_location(button0, file$4, 60, 4, 2002);
    			add_location(button1, file$4, 61, 4, 2075);
    			add_location(button2, file$4, 62, 4, 2147);
    			add_location(h41, file$4, 64, 4, 2231);
    			add_location(button3, file$4, 65, 4, 2264);
    			add_location(button4, file$4, 66, 4, 2352);
    			add_location(h42, file$4, 68, 4, 2442);
    			add_location(button5, file$4, 69, 4, 2474);
    			add_location(button6, file$4, 70, 4, 2543);
    			add_location(h43, file$4, 72, 1, 2619);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file$4, 73, 1, 2638);
    			add_location(div, file$4, 58, 0, 1954);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (52:2) {#each links.filter(e => e.isNav !== false) as link, i}
    function create_each_block$1(ctx) {
    	let t0;
    	let a;
    	let t1_value = /*link*/ ctx[5].title + "";
    	let t1;
    	let a_href_value;
    	let a_class_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*currentLink*/ ctx[2].path === /*link*/ ctx[5].path
    			? "active"
    			: "") + " svelte-81onu1"));

    			add_location(a, file$6, 53, 3, 1512);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*currentLink*/ 4 && a_class_value !== (a_class_value = "" + (null_to_empty(/*currentLink*/ ctx[2].path === /*link*/ ctx[5].path
    			? "active"
    			: "") + " svelte-81onu1"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(52:2) {#each links.filter(e => e.isNav !== false) as link, i}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	let t10;
    	let current;
    	let each_value = /*links*/ ctx[3].filter(func);
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	var switch_value = /*currentLink*/ ctx[2].component;
    	...
    	if (switch_value) {
    		...
    		switch_instance.$on("saveData", /*saveData_handler*/ ctx[4]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = text(t9_value);
    			t10 = text(".");
    			add_location(h2, file$6, 47, 1, 1336);
    			add_location(nav, file$6, 49, 1, 1364);
    			attr_dev(div, "class", "page");
    			add_location(div, file$6, 58, 1, 1629);
    			attr_dev(a, "href", a_href_value = appData.githubUrl);
    			attr_dev(a, "class", "svelte-81onu1");
    			add_location(a, file$6, 63, 17, 1784);
    			add_location(small, file$6, 63, 2, 1769);
    			add_location(footer, file$6, 62, 1, 1758);
    			add_location(main, file$6, 46, 0, 1328);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*links, currentLink*/ 12) {
    				each_value = /*links*/ ctx[3].filter(func);
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (switch_value !== (switch_value = /*currentLink*/ ctx[2].component)) {
    				if (switch_instance) {
    					group_outros();
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentLink" in $$props) $$invalidate(2, currentLink = $$props.currentLink);
    	};
    	...
    	return [options, results, currentLink, links, saveData_handler];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { options: 0, results: 1 });
