...
var app = (function () {
    ...
    var version = "14 Sep 2020 11:21:07";
...
Ship Reaction:         ${results.reaction.type}`
    ...
    // (51:2) {#each links.filter(e => e.isNav !== false) as link, i}
    function create_each_block$1(ctx) {
    	...
    	let a_href_value;
    	let a_class_value;
    	let if_block = /*i*/ ctx[9] > 0 && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*currentLink*/ ctx[2].path === /*link*/ ctx[7].path
    			? "active"
    			: "") + " svelte-81onu1"));

    			add_location(a, file$6, 52, 3, 1475);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*currentLink*/ 4 && a_class_value !== (a_class_value = "" + (null_to_empty(/*currentLink*/ ctx[2].path === /*link*/ ctx[7].path
    			? "active"
    			: "") + " svelte-81onu1"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:2) {#each links.filter(e => e.isNav !== false) as link, i}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	if (switch_value) {
    		...
    		switch_instance.$on("saveData", /*saveData_handler*/ ctx[5]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = text(t9_value);
    			t10 = text(".");
    			add_location(h2, file$6, 46, 1, 1299);
    			add_location(nav, file$6, 48, 1, 1327);
    			attr_dev(div, "class", "page");
    			add_location(div, file$6, 56, 1, 1591);
    			attr_dev(a, "href", a_href_value = appData.githubUrl);
    			attr_dev(a, "class", "svelte-81onu1");
    			add_location(a, file$6, 61, 17, 1746);
    			add_location(small, file$6, 61, 2, 1731);
    			add_location(footer, file$6, 60, 1, 1720);
    			add_location(main, file$6, 45, 0, 1291);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	if (!isLocal) {
    		baseRoute = "/alienrpg";
    		page.base(baseRoute); // as per prod hosting
    	}
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("isLocal" in $$props) $$invalidate(4, isLocal = $$props.isLocal);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("results" in $$props) $$invalidate(1, results = $$props.results);
    		if ("isLocal" in $$props) $$invalidate(4, isLocal = $$props.isLocal);
    		if ("baseRoute" in $$props) baseRoute = $$props.baseRoute;
    	...
    	return [options, results, currentLink, links, isLocal, saveData_handler];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { options: 0, results: 1, isLocal: 4 });
    		...
    		if (/*isLocal*/ ctx[4] === undefined && !("isLocal" in props)) {
