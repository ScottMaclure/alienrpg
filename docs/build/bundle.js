...
`
    ...
    function create_fragment(ctx) {
    	...
    	let div0;
    	let small0;
    	let t0_value = /*appData*/ ctx[0].version + "";
    	let t0;
    	let t1;
    	let h2;
    	let t2_value = /*appData*/ ctx[0].title + "";
    	let t2;
    	let t3;
    	let p;
    	let t4;
    	...
    	let footer;
    	let small1;
    	let t18_value = /*appData*/ ctx[0].title + "";
    	let t18;
    	let t19;
    	let t20_value = /*appData*/ ctx[0].version + "";
    	let t20;
    	let t21;
    	let a;
    	let t22;
    	let a_href_value;
    	let t23;
    	let t24_value = /*appData*/ ctx[0].copyright + "";
    	let t24;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t24 = text(t24_value);
    			add_location(small0, file, 29, 25, 715);
    			attr_dev(div0, "class", "alignRight");
    			add_location(div0, file, 29, 1, 691);
    			add_location(h2, file, 30, 1, 755);
    			add_location(i, file, 32, 15, 797);
    			add_location(strong, file, 32, 7, 789);
    			add_location(p, file, 32, 1, 783);
    			add_location(button, file, 34, 1, 877);
    			add_location(legend, file, 37, 3, 965);
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file, 40, 5, 1016);
    			add_location(label, file, 39, 4, 1003);
    			add_location(div1, file, 38, 3, 993);
    			add_location(fieldset, file, 36, 2, 951);
    			add_location(form, file, 35, 1, 942);
    			add_location(h3, file, 46, 1, 1196);
    			attr_dev(pre, "id", "results");
    			add_location(pre, file, 47, 1, 1214);
    			attr_dev(a, "href", a_href_value = /*appData*/ ctx[0].githubUrl);
    			add_location(a, file, 50, 52, 1310);
    			add_location(small1, file, 50, 2, 1260);
    			add_location(footer, file, 49, 1, 1249);
    			add_location(main, file, 28, 0, 683);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			input.checked = /*options*/ ctx[1].showUninhabitedDetails;
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*appData*/ 1 && t0_value !== (t0_value = /*appData*/ ctx[0].version + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*appData*/ 1 && t2_value !== (t2_value = /*appData*/ ctx[0].title + "")) set_data_dev(t2, t2_value);
    			...
    			if (dirty & /*appData*/ 1 && t18_value !== (t18_value = /*appData*/ ctx[0].title + "")) set_data_dev(t18, t18_value);
    			if (dirty & /*appData*/ 1 && t20_value !== (t20_value = /*appData*/ ctx[0].version + "")) set_data_dev(t20, t20_value);

    			if (dirty & /*appData*/ 1 && a_href_value !== (a_href_value = /*appData*/ ctx[0].githubUrl)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if (dirty & /*appData*/ 1 && t24_value !== (t24_value = /*appData*/ ctx[0].copyright + "")) set_data_dev(t24, t24_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let options = { showUninhabitedDetails: false };
    	...
    	function toggleHideUninhabited() {
    		$$invalidate(1, options.showUninhabitedDetails = !options.showUninhabitedDetails, options);
    		$$invalidate(2, output = starSystemPrinter.printStarSystem(results, options));
    	}

    	const writable_props = ["appData", "starData"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("starData" in $$props) $$invalidate(5, starData = $$props.starData);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { appData: 0, starData: 5 });
    		...
    		if (/*starData*/ ctx[5] === undefined && !("starData" in props)) {
