...
var app = (function () {
    ...
    var version = "15 Sep 2020 08:27:52";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$6, 49, 3, 1290);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = text(t9_value);
    			t10 = text(".");
    			add_location(h2, file$6, 44, 1, 1167);
    			add_location(nav, file$6, 46, 1, 1195);
    			attr_dev(div, "class", "page");
    			add_location(div, file$6, 55, 1, 1515);
    			attr_dev(a, "href", a_href_value = appData.githubUrl);
    			attr_dev(a, "class", "svelte-81onu1");
    			add_location(a, file$6, 60, 17, 1670);
    			add_location(small, file$6, 60, 2, 1655);
    			add_location(footer, file$6, 59, 1, 1644);
    			add_location(main, file$6, 43, 0, 1159);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
